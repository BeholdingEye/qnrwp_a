...
<?php
// Create meta, OpenGraph and Twitter card tags, per post or generic
echo qnrwp_meta_opengraph_twitter_tags();
// Debugging printout block, here for testing
...
<?php 
  ...
  //qnrwp_debug_printout(array('have posts: ' => have_posts(),
                              //'is singular: ' => is_singular(),
                              //'title: ' => get_the_title()),$append=true);
