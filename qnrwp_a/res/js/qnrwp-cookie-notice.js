...
QNRWP.CookieNotice.cookie_notice_dismissed = function () {
    if (QNR.getCookieValue("qnrwp-cookie-notice-dismissed") != 1) {
...
QNRWP.CookieNotice.close_cookie_notice = function (obj, event) {
    ...
    QNR.createOrUpdateCookie("qnrwp-cookie-notice-dismissed", 1, 0, true); // Name, value, duration, secure (path automatic)
