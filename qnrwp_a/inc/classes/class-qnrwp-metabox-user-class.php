...
/**
 * Metabox class, allowing user to set own CSS class on post in admin (a singleton) NOT USED, this is sample code
 * 
...
class QNRWP_Metabox_User_Class {
  ...
  public function qnrwp_save_user_post_class_meta($post_id, $post) {
    ...
    else if ($new_meta_value && $new_meta_value != $meta_value) update_post_meta($post_id, $meta_key, $new_meta_value);
    // If there is no new meta value but an old value exists, delete it
    else if ($new_meta_value == '' && $meta_value) delete_post_meta($post_id, $meta_key, $meta_value);
  }
