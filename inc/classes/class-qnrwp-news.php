...
final class QNRWP_News {
  ...
  /**
   * Filters Recent Posts widget args to get news posts only
   */
  ...
  /**
   * First of two functions filtering archives call to return news posts only
   */
  ...
  /**
   * Second of two functions filtering archives call to return news posts only
   */
  ...
  /**
   * Filters next prev and day links in caledar widget for news posts only, by filtering the SQL query, as no higher level method available
   */
